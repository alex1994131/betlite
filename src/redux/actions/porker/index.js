...
export const providerchange = (value,bool)=>{
    return async(dispatch,getState) =>{
        if(value !== "All"){
            var provider = getState().porkerlist.moredata.find(obj => obj.provider === value);
            ...
            dispatch({
                type : PORKERLIST_TYPE,data : {name : "All" ,value:"All"}
            });
        }
        dispatch({
            type : PORKERLIST_SETPROVIDER,setprovider : {name :value ,value:value}
        });
...
export const gametypechange = (value)=>{
    return async(dispatch,getState)=>{        
        dispatch({
            type : PORKERLIST_TYPE,data : {name : value ,value:value}
        });
